namespace FileIndex
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            issueNo.ReadOnly = true;
            issueNo.Size = new Size(171, 29);
            issueNo.TabIndex = 2;
            issueNo.Tag = "stampcontroll";
            issueNo.TextAlign = HorizontalAlignment.Center;
            toolTip1.SetToolTip(issueNo, "Select the issue date. The issue number will be generated automatically.");
            // 
            // label1
            // 
            ...
            toolTip1.SetToolTip(postmarkPrice, "Change carefully because this value is the same in every issue.");
