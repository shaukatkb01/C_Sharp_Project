...
namespace FileIndex
{
    ...
    public partial class InvoiceEntrycs : Form
    {
            ...
            using (SqlConnection con = new SqlConnection(Db.ConString))
            {
                try
                {
                 ...
                 ORDER BY F.Id DESC";
                    ...
                    adapter.Fill(dt);
                    string query2 = @"SELECT Id, Address 
                    ...
                    if (dt.Rows.Count > 0 && dt2.Rows.Count > 0 ) // Check karein ke kya database se data aaya?
                    {
                        // for FileNo Combo
                        ...
                        com_PhilName.DisplayMember = "Address";
        ...
        private void btn_save_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(Db.ConString))
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@remarks", string.IsNullOrWhiteSpace(Remark_txt.Text)
                        ?(object)DBNull.Value:Remark_txt.Text);
        ...
        private void num_Stamp_ValueChanged(object sender, EventArgs e)
        {
            CalculateTotal();
        }
